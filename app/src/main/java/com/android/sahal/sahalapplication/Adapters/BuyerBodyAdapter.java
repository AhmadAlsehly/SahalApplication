...
public class BuyerBodyAdapter extends RecyclerView.Adapter<BuyerBodyAdapter.MyViewHolder> {
    ...
    public BuyerBodyAdapter(Context mContext, List<ModuleItem> itemsList) {
    ...
    @Override
    public BuyerBodyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
