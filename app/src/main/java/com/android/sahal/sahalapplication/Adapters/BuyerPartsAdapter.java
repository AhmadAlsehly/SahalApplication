...
public class BuyerPartsAdapter extends RecyclerView.Adapter<BuyerPartsAdapter.MyViewHolder>  {
    ...
    public BuyerPartsAdapter(Context mContext, List<ModuleItem> itemsList) {
