 ...
 * {@link FragmentEngine.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentEngine#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentEngine extends Fragment implements BuyerEngineAdapter.onItemClickListener, SearchView.OnQueryTextListener {
...
//--------------------------------------------------------------------------------
    ...
    private BuyerEngineAdapter buyerEngineAdapter;


//____________________________________________

    public static FragmentEngine newInstance() {
        return new FragmentEngine();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.engine_recyclerView);
        itemList = new ArrayList<>();
        buyerEngineAdapter = new BuyerEngineAdapter(this.getContext(), itemList);
        ...
        recyclerView.setAdapter(buyerEngineAdapter);
...
//_______________________________________________
    ...
    public static FragmentEngine newInstance(String param1, String param2) {
...
//                    sellerHomeAdapter.notifyDataSetChanged();
                ...
                buyerEngineAdapter.notifyDataSetChanged();
            }
...
//____________________________________________________________
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragment_engine, container, false);
    }
